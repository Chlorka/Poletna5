...
$this->setFrameMode(true);?>
    ...
    <div class="container" id="catalog-detail">
        <ul class="tabs catalog-tabs">
            <li><a href="#tab1">Описание</a></li>
            <?if(strlen($arResult['DISPLAY_PROPERTIES']['TECH']['~VALUE']['TEXT'])>0):?>
                <li><a href="#tab2">Технические характеристики</a></li>
            <?endif;?>
            <?if($arResult['DISPLAY_PROPERTIES']['COLOR_1']['VALUE'] || $arResult['DISPLAY_PROPERTIES']['COLOR_2']['VALUE']):?>
                <li><a href="#tab3">Расцветки</a></li>
            <?endif;?>
        </ul>
        <div class="clear"></div>
        <div class="tab_container">
            <div id="tab1" class="tab_content">
                <div class="right_text">
                    ...
                    <div class="photo">
                        <div class="first_img">
                            <img src="<?=$arResult["BIG_PHOTO"]["SRC"]?>" alt="<?=$arResult["DETAIL_PICTURE"]["ALT"]?>" title="<?=$arResult["DETAIL_PICTURE"]["TITLE"]?>" width="<?=$arResult["BIG_PHOTO"]["WIDTH"]?>" height="<?=$arResult["BIG_PHOTO"]["HEIGHT"]?>">
                        </div>
                        <?if(count($arResult["MINI_PHOTO"]) > 0):?>
                            <div class="more-photo">
                                <?foreach($arResult["MINI_PHOTO"] as $key => $photo):?>
                                    <a class="fancybox" rel="photo" href="<?=CFile::GetPath($arResult["DISPLAY_PROPERTIES"]["MORE_PHOTO"]["VALUE"][$key]);?>">
                    ...
                    <?if($arResult['DISPLAY_PROPERTIES']['STATISTIKA']['VALUE']):?>
                        <img class="img-stat" src="<?=$arResult['DISPLAY_PROPERTIES']['STATISTIKA']['FILE_VALUE']["SRC"]?>" alt="<?=$arResult["DETAIL_PICTURE"]["ALT"]?>" title="<?=$arResult["DETAIL_PICTURE"]["TITLE"]?>" width="<?=$arResult['DISPLAY_PROPERTIES']['STATISTIKA']['FILE_VALUE']["WIDTH"]?>" height="<?=$arResult['DISPLAY_PROPERTIES']['STATISTIKA']['FILE_VALUE']["HEIGHT"]?>">
                    <?endif;?>
                    <div class="text"><? echo $arResult['DETAIL_TEXT']; ?></div>
                </div>
            </div>
            <div id="tab2" class="tab_content">
                <div class="text"><? echo $arResult['DISPLAY_PROPERTIES']['TECH']['~VALUE']['TEXT']; ?></div>
            </div>
            <div id="tab3" class="tab_content">
                <?if($arResult['DISPLAY_PROPERTIES']['COLOR_1']['VALUE']):?>
                    <div class="center"><img src="<?=$arResult['DISPLAY_PROPERTIES']['COLOR_1']['FILE_VALUE']["SRC"]?>" alt="<?=$arResult["DETAIL_PICTURE"]["ALT"]?>" title="<?=$arResult["DETAIL_PICTURE"]["TITLE"]?>" width="<?=$arResult['DISPLAY_PROPERTIES']['COLOR_1']['FILE_VALUE']["WIDTH"]?>" height="<?=$arResult['DISPLAY_PROPERTIES']['COLOR_1']['FILE_VALUE']["HEIGHT"]?>"></div>
                <?endif;?>
                <div class="text"><? echo $arResult['DISPLAY_PROPERTIES']['COLOR_TEXT']['~VALUE']['TEXT']; ?></div>
                <?if($arResult['DISPLAY_PROPERTIES']['COLOR_2']['VALUE']):?>
                    <div class="center"><img src="<?=$arResult['DISPLAY_PROPERTIES']['COLOR_2']['FILE_VALUE']["SRC"]?>" alt="<?=$arResult["DETAIL_PICTURE"]["ALT"]?>" title="<?=$arResult["DETAIL_PICTURE"]["TITLE"]?>" width="<?=$arResult['DISPLAY_PROPERTIES']['COLOR_2']['FILE_VALUE']["WIDTH"]?>" height="<?=$arResult['DISPLAY_PROPERTIES']['COLOR_2']['FILE_VALUE']["HEIGHT"]?>"></div>
                <?endif;?>
            </div>
        </div>
    </div>
