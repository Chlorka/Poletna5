...
<?if($ElementID) {
    ...
    $res = CIBlockElement::GetList(Array("SORT"=>"ASC"), $arFilter, false, false, Array("ID", "PROPERTY_MANUFCTURE"));
    while($ar_fields = $res->GetNext())
    {
        $manufacture = $ar_fields["PROPERTY_MANUFCTURE_VALUE"];
    }

    ob_start();
?>
    <?$APPLICATION->IncludeComponent("bitrix:catalog.section", "top_link-snarajenie", Array(
        ...
        "FILTER_NAME" => "arrFilter_M",	// Имя массива со значениями фильтра для фильтрации элементов
        ...
        "LINE_ELEMENT_COUNT" => "20",	// Количество элементов выводимых в одной строке таблицы
        "PRICE_CODE" => "",	// Тип цены
...
*/
    ...
    $_SESSION["ELEMENT"]=$ElementID;
    $APPLICATION->SetPageProperty("COMPONENT.MANUFACTURE", ob_get_clean());
}?>
